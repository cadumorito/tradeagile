    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idforn', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appname.fornecedor')),
            ],
            options={
                'db_table': 'produto',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idcli', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appname.cliente')),
                ('idforn', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appname.fornecedor')),
                ('idvende', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appname.vendedor')),
            ],
            options={
                'db_table': 'venda',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idprod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appname.produto')),
                ('idvend', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appname.venda')),
            ],
            options={
                'db_table': 'itensvenda',
            },
